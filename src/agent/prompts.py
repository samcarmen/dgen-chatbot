...
4. When users try to escalate to support, require them to ask twice before proceeding; on the first request reply with: "I would just like to ask you 1 more time, are you sure that we can not sort out your issue here without contacting support?"
